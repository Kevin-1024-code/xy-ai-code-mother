package com.xy.xyaicodemother.utils;
...
public class WebScreenshotUtils {
    ...
    private static WebDriver initChromeDriver(int width, int height) {
        try {
            ...
            // 你的真实路径，注意 Windows 下路径需要转义或者用正斜杠
            System.setProperty("webdriver.chrome.driver", "C:\\Users\\zyb_1\\Documents\\GitHub\\xy-ai-code-mother\\driver\\chromedriver.exe");
